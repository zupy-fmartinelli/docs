...
<Card title="Partner Account Access" icon="user-check">
  ...
  **Don't have access?** Contact [webmaster@zupy.com.br](mailto:webmaster@zupy.com.br)
</Card>
...
- **Support Contact**: [webmaster@zupy.com.br](mailto:webmaster@zupy.com.br) for production issues
