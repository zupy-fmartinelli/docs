...
If you don't see the developer section in your dashboard, contact our partner team at [dev@zupy.com](mailto:dev@zupy.com) to enable developer access for your account.
...
- Contact support at [dev@zupy.com](mailto:dev@zupy.com) if issues persist
</Accordion>
...
<Note>
  **Support**: Contact [dev@zupy.com](mailto:dev@zupy.com) if you encounter any issues during authentication setup or need assistance with API key configuration.
</Note>