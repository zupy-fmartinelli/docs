...
description: "Find existing customers using phone number or email address as search criteria"
---
...
<Note>
  **Search Options**: You can search using phone number or email address. The `q` parameter is required.
</Note>
