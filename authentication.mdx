...
<Note>
  **Partner Account Required**: You need an active Zupy partner account. Contact [dev@zupy.com](mailto:dev@zupy.com) if you don't have access.
</Note>
...
- Contact [dev@zupy.com](mailto:dev@zupy.com) if issues persist
</Accordion>
